                      ...
                      widget = Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            4.widthBox(),
                            Text(e.name.capitalizeFirst??'',style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 16),)
                          ],
                        ),
                      );
                    }
                    else{
                      widget = const Icon(Icons.home_filled,color: AppColors.white,);
                    }
                    break;
                  case HomeTabs.download :
                    if(xSelected){
                      widget = Container(
                        ...
                        child: Row(
                          children: [
                            const Icon(Icons.archive_rounded,color: AppColors.black,),
                            4.widthBox(),
                            Text(e.name.capitalizeFirst??'',style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 16),)
                          ],
                        ),
                      ...
                      widget = const Icon(Icons.archive_rounded,color: AppColors.white,);
                    }
                    break;
                  case HomeTabs.about :
                    if(xSelected){
                      ...
                      widget = const Icon(Icons.info_rounded,color: AppColors.white,);
                    }
                    break;
                }
